...
<p align="center">Aplicação <strong>"TO-DO"</strong> (Lista de todas as tarefas que você precisa realizar), utilizando <strong>Vue CLI</strong> e focado no front-end.
  </p>
